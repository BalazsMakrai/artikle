...
<template>
    <div class="container" :style="isDarkMode ? { backgroundColor: 'rgb(73,72,72)' } : { backgroundColor: 'transparent' }">
        <div class="content-container">
            <h3 :style="isDarkMode ? { color: 'white' } : { color: 'black' }">Reading List</h3>
